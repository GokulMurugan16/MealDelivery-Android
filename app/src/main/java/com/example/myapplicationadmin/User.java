...
public class User extends AppCompatActivity {
    ...
    public void signInUser(View view)
    {
        if(!username.getText().toString().isEmpty()&&!password.getText().toString().isEmpty()) {
            ...
            mAuth.signInWithEmailAndPassword(userNameUser, passwordUser)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent i = new Intent(User.this, UserRecyclerView.class);
                                startActivity(i);
        ...
        {
            Toast.makeText(User.this, " Invalid Details", Toast.LENGTH_SHORT).show();
        }
    }


    public void signUpUserGoogle(View view)
    {
